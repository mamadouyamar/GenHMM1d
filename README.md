...
> ### 📓 Start with the worked examples: [`examples.ipynb`](examples.ipynb) and [**▶ Run it in Colab**](https://colab.research.google.com/github/mamadouyamar/GenHMM1d/blob/master/examples.ipynb)
